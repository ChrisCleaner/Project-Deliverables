...
cp HPC_Threading_multiple.py "$TMPDIR/input/$1/Batch $SLURM_ARRAY_TASK_ID"
cp "Meta Data Treaties.csv" "$TMPDIR"/input/meta_data
...
#run script
python "$TMPDIR/input/$1/Batch $SLURM_ARRAY_TASK_ID/HPC_Threading_multiple.py" $SLURM_ARRAY_TASK_ID $1 
